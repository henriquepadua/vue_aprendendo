...
//Fazendo o roteamento das páginas
const routes = {
  '/': Principal,
  '/books': Books,
  '/authors': Authors,
  '/create_book': Create
  // '/mw_borrowed': Borrowed,
}
...
const currentView = computed(() => {
  return routes[referenciaRota.value.slice(1) || '/']
})

//Consumindo api de autores
const authors = ref([])
      ...
      <aside class="navbar navbar-vertical navbar-expand-sm navbar-dark">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav pt-lg-3">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#/mw_borrowed">
                <span
